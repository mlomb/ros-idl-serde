...
namespace rcl_interfaces {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "rcl_interfaces/msg/Parameter";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This is the message to communicate a parameter. It is an open struct with an enum in
# the descriptor to select which value is active.
