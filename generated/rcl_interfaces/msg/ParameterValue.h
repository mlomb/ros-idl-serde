...
namespace rcl_interfaces {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "rcl_interfaces/msg/ParameterValue";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Used to determine which of the next *_value fields are set.
# ParameterType.PARAMETER_NOT_SET indicates that the parameter was not set
# (if gotten) or is uninitialized.
# Values are enumerated in `ParameterType.msg`.
