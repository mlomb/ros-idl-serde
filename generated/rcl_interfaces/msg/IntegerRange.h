...
namespace rcl_interfaces {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "rcl_interfaces/msg/IntegerRange";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Represents bounds and a step value for an integer typed parameter.
