...
namespace rcl_interfaces {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "rcl_interfaces/msg/ParameterEventDescriptors";
static constexpr std::string_view MCAP_SCHEMA = R"mcap_schema(================================================================================
IDL: rcl_interfaces/msg/ParameterEventDescriptors
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This message contains descriptors of a parameter event.
# It was an atomic update.
# A specific parameter name can only be in one of the three sets.
