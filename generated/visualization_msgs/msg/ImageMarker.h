...
namespace visualization_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "visualization_msgs/msg/ImageMarker";
static constexpr std::string_view MCAP_SCHEMA = R"mcap_schema(================================================================================
IDL: visualization_msgs/msg/ImageMarker
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(int32 CIRCLE=0
int32 LINE_STRIP=1
int32 LINE_LIST=2
int32 POLYGON=3
int32 POINTS=4
