...
#include "visualization_msgs/msg/InteractiveMarkerControl.h"
...
namespace visualization_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "visualization_msgs/msg/InteractiveMarker";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Time/frame info.
# If header.time is set to 0, the marker will be retransformed into
# its frame on each timestep. You will receive the pose feedback
# in the same frame.
# Otherwise, you might receive feedback in a different frame.
