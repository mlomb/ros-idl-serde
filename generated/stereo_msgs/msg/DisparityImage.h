...
namespace stereo_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "stereo_msgs/msg/DisparityImage";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Separate header for compatibility with current TimeSynchronizer.
# Likely to be removed in a later release, use image.header instead.
