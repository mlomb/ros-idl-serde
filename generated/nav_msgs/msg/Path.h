...
namespace nav_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "nav_msgs/msg/Path";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# An array of poses that represents a Path for a robot to follow.
