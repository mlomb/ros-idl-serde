...
namespace nav_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "nav_msgs/msg/GridCells";
static constexpr std::string_view MCAP_SCHEMA = R"mcap_schema(================================================================================
IDL: nav_msgs/msg/GridCells
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# An array of cells in a 2D grid
