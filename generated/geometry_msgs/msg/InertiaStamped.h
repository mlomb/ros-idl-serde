...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/InertiaStamped";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# An Inertia with a time stamp and reference frame.
