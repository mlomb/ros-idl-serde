...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/PoseStamped";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# A Pose with reference coordinate frame and timestamp
