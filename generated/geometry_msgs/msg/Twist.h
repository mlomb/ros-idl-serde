...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/Twist";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This expresses velocity in free space broken into its linear and angular parts.
