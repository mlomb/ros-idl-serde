...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/Polygon";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# A specification of a polygon where the first and last points are assumed to be connected
