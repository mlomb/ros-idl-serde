...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/TransformStamped";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This expresses a transform from coordinate frame header.frame_id
# to the coordinate frame child_frame_id at the time of header.stamp
#
# This message is mostly used by the
# <a href="https://index.ros.org/p/tf2/">tf2</a> package.
