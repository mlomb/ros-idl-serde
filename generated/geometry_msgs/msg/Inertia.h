...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/Inertia";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Mass [kg]
float64 m
