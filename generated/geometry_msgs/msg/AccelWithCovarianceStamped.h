...
namespace geometry_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "geometry_msgs/msg/AccelWithCovarianceStamped";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This represents an estimated accel with reference coordinate frame and timestamp.
