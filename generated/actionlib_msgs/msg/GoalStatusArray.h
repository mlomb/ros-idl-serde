...
namespace actionlib_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "actionlib_msgs/msg/GoalStatusArray";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Stores the statuses for goals that are currently being tracked
# by an action server
