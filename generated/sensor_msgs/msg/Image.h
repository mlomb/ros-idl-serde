...
namespace sensor_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "sensor_msgs/msg/Image";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This message contains an uncompressed image
# (0, 0) is at top-left corner of image
