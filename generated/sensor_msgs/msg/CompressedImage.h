...
namespace sensor_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "sensor_msgs/msg/CompressedImage";
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# This message contains a compressed image.
