...
namespace sensor_msgs {
    namespace msg {
        ...
        {
        public:
static constexpr std::string_view PACKAGE_RESOURCE_NAME = "sensor_msgs/msg/TimeReference";
static constexpr std::string_view MCAP_SCHEMA = R"mcap_schema(================================================================================
IDL: sensor_msgs/msg/TimeReference
...
static constexpr std::string_view MCAP_MSG_SCHEMA = R"mcap_msg_schema(# Measurement from an external time source not actively synchronized with the system clock.
